...
class Database:
	def __init__(self,master):
		...
		self.vendor_phone_1 = Label(master,text="Enter Phone Number ",font=('arial 18 bold'))
		...
		self.btn_add.place(x=530,y=520)
		

		#text box for the logs
		self.tBox = Text(master,width=62,height=18)
		self.tBox.place(x=854,y=70)
